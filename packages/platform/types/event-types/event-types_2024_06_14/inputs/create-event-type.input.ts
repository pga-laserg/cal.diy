...
export class CalVideoSettings {
  ...
  @IsBoolean()
  @DocsPropertyOptional({
    description: "Send emails with the transcription of Daily Video after the meeting ends.",
    default: true,
  })
